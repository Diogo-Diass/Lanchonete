...
import br.senai.sp.cpf138.Lanchonete.repository.AvaliacaoRepository;
...
public class AvaliacaoRestController {
	...
	public List<Avaliacao> getListaAvaliacao(@PathVariable("idLanchonete") Long idLanchonete){
		
		return repository.findByLanchoneteId(idLanchonete);
